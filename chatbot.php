   ...
   <body>
      ...
      <script type="text/javascript">
		 ...
		 function send_msg(){
			...
			var html='<li class="messages-me clearfix"><span class="message-img"><img src="assets/images/user_avatar.png" class="avatar-sm rounded-circle"></span><div class="message-body clearfix"><div class="message-header"><strong class="messages-title">Me</strong> <small class="time-messages text-muted"><span class="fas fa-time"></span> <span class="minutes">'+getCurrentTime()+'</span></small> </div><p class="messages-p">'+txt+'</p></div></li>';
